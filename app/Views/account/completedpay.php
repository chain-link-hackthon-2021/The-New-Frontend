                    ...
                    <div class="row">
                        <div class="col">
                            <div class="invoice p-3 " id="invoice">
                                        ...
                                        <div style="line-height: 44px;">
                                            ...
                                            <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
                                                <p style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                                                    Your order details from <b> <?= $orders["shopName"] ?> </b> are below.<br />
                                ...
                                <div class="row">
                                    <div class="col-md-12 table-responsive">
                                        <table class="table table-borderless" style="word-wrap:break-word; background-color:#fbfcfd" ;>
                                            <thead>
                                                <tr>
                                                    <th>Quantity</th>
                                                    <th>Product</th>
                            ...
                            <div class="card card-modern">
                                ...
                                <tr>
                                    <td align="center" bgcolor="#fbfcfd" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #eff2f4;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <div style="height: 20px; line-height: 60px; font-size: 10px;"> </div>
                                                    <button href="">Leave Feedback for Seller</button>
                                                    <div style="height: 20px; line-height: 60px; font-size: 10px;"> </div>
