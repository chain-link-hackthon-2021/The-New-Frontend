                        ...
                        <div class="client-profile-photo">
                            ...
                            <div class="profile-meta text-center pt-50">
                                ...
                                <div class="float-end" style="margin-right: 30px;">
                                    <a class="btn btn-primary" id="newshopbutton"
                                        href="/Shop/CreateShop/CreateShop">Create A New Shop</a>
                                </div>
                            </div>
                                        ...
                                        <div class="card-style project-card mb-30">
                                            <div class="title mb-10 d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="more-btn-wrapper">
                                                    <a class="text-danger btn"
                                                        onclick="deleteFunction(<?= $shop['id'] ?>,'<?= $shop['name']; ?>');">
                                                ...
                                                <div class="activity-meta">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <span
                                                                class="text-medium text-dark"><?= date("Y-m-d H:i:s", strtotime($shop['created_at']));   ?></span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="card-footer p-0 bg-transparent">
                                                <div class="project-image">
                                                    <a href="/Shop/<?= $shop['name']; ?>/Dashboard"
                                                        class="main-btn primary-btn btn-sm btn-hover"
                                                        style="width:100%;color:#F4F9F9;">Dashboard</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Card -->
