                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body" style="padding: 0;">
                                        <div class="img-header" style="width: 100%; height: 250px;background-image: url('<?= $storeImg; ?>');background-position: center;background-size: cover;" ></div>
                                        <div class="row justify-content-center">
                                            <img id="blah" style="width: 100px;position: absolute;margin-top: -53px;" class="img-circle img-bordered-sm" src='<?= $user[0]['display_picture']; ?>' alt="User Image">
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p>
                                                Feedback: <span class="text-success"><?= count($feedbacks); ?> </span> / <span class="text-secondary"> <?= count($orders); ?> </span> / <span class="text-danger"> 0 </span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        ?>
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                <div class="card" style="margin: 10px 0;">
                                                    ...
                                                    <a data-turbolinks="false" class="profile__product" href="/@<?= $name; ?>/Product/<?= $product['uniqueID']; ?>">
                                                        <?php
                                                        ...
                                                        <div class="profile__product__info">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <span class="mla <?= $stockClass; ?>"><strong><?= $product['stock']; ?> In Stock</strong></span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
