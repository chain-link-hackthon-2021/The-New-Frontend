        ...
        <form class="row" action="/@<?= $name; ?>/Product/<?= $products[0]['uniqueID']; ?>" method="POST">
            ...
            <div class="col-lg-8 col-md-7">
                <div id="productBar" class="card-style mb-30">
                    ...
                    <hr />
                    <input type="text" class="form-control" value="<?= $products[0]['productName']; ?>" name="productName" id="productName" placeholder="" hidden>
            ...
            <div class="col-lg-4 col-md-5">
                <div  id="qtyBar"  class="card-style mb-30 text-center" >
                    ...
                    <div class="input-style-1" style="display: inline-flex;">
                        ...
                        <input type="number" name="Quantity" value="<?= $quantity; ?>" style="text-align: center;" id="Quantity" >
                        <button type="button" id="increaseQuantityButton" class="btn btn-primary" style="width: 60px;"> <strong> + </strong> </button>
                    </div>
                    <div class="result text-center">
                        <div>
                            <input type="hidden" name="unitPrice" id="unitPrice" value="<?= $products[0]['productPrice']; ?>">
                            <input type="hidden" name="productPrice" id="productPrice" value="<?= $products[0]['productPrice'] *  $quantity; ?>">
                        ...
                        <style>
                            ...
                            #couponMessage, #couponNameMessage{
                                font-size: 10px;
                            }
                        </style>
