                    ...
                    <div class="row">
                        <div class="col text-center">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                <input class="custom-control-input" id="sw-stripe" type="checkbox" <?php if ($products['product'][0]['stripeEnabled'] == "true") {
                        ...
                        <div class="col text-center">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                <input class="custom-control-input" id="sw-coinbase-commerce" <?php if ($products['product'][0]['coinbaseCommerceEnabled'] == "true") {
                                                                                                    echo "checked='checked'";
                                                                                                } ?> type="checkbox" data-val="true" name="CoinbaseCommerceEnabled" value="true">
                        ...
                        <div class="col text-center">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                <input class="custom-control-input" id="sw-paypal" <?php if ($products['product'][0]['payPalEnabled'] == "true") {
                                                                                        echo "checked='checked'";
                                                                                    } ?> type="checkbox" data-val="true" data-val-required="The PayPal field is required." name="PayPalEnabled" value="true">
