...
<form enctype="multipart/form-data" action="/Shop/<?= $name; ?>/ProductEdit/<?= $uniqueID; ?>" method="post" class="">
    ...
    <div class="row justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="input-style-1">
                        ...
                        <input type"text" id="ProductName" maxlength="58" name="ProductName" disabled
                            value="<?= $products['product'][0]['productName'] ?>" required />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="input-style-1">
                ...
                <div class="col-md-4">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="ProductPrice" maxlength="58" name="ProductPrice"
                            value="<?= $products['product'][0]['productPrice'] ?>" placeholder="0.0" required />
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="description" id="description" cols="30"
                            rows="10"><?= $products['product'][0]['description'] ?></textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="input-style-1">
        ...
        <div class="col-md-4">
            <div class="row">
                <div class="col-md-12" style="background-color: #fff;  border-radius: 12px; margin-bottom: 20px">
                    <h5 class="mb-25">Set Product Image</h5>
                    <hr>
                    <div class="text-center bg-gray-light">
                        ...
                        <img style="height:200px;" id="blah" class="img-fluid"
                            src="<?= $products['product'][0]['productImage']; ?>" alt="your image">
                    </div>
                    <div class="input-style-1">
                ...
                <div class="col-md-12"
                    style="background-color: #fff; padding: 15px; border-radius: 12px; margin-bottom: 20px">
                    <h5 class="mb-25">Product Options</h5>
                    <div class="form-group col-md-12">
                        <label class="control-label" for="Position">Position</label>
                        <input class="form-control" type="number" data-val="true"
                            data-val-required="The Position field is required." id="Position" name="Position"
                            value="100000" />
                    </div>
                    <div class="form-group col-md-12">
                        <label class="control-label" for="WebhookUrl">Webhook URL</label>
                        <input class="form-control" type="text" id="WebhookUrl"
                            value="<?= $products['product'][0]['webhookUrl'] ?>" name="WebhookUrl"
                            placeholder="Discord hooks supported!" value="" />
                    </div>
                    <div class="form-group col-md-12">
                        <label class="control-label" for="CallbackURL">Callback URL</label>
                        <input class="form-control" type="text" id="CallbackURL"
                            value="<?= $products['product'][0]['callbackURL'] ?>" maxlength="100" name="CallbackURL"
                            value="" />
                    </div> <br><br>
                    <div class="row">
                        <div class="col">
                            ...
                            <i class="fa fa-question-circle" rel="tooltip"
                                title="This product won't show on your shop page"></i>
                        </div>
                        <div class="col-auto">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="sw-unlisted" data-val="true"
                                    data-val-required="The Unlisted field is required." name="Unlisted" value="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="sw-blockproxy" data-val="true"
                                    data-val-required="The Block VPNs/Proxies field is required." name="BlockProxy"
                                    value="true">
