    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <li class="nav-item nav-item-has-children <?php if ($uri == 'Settings') {
          ...
          <a href="/Shop/<?= $name; ?>/Settings" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_55" aria-controls="ddmenu_55" aria-expanded="false" aria-label="Toggle navigation">
            <span class="icon">
